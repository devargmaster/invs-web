...
export function TiendaTransferPage() {
  ...
  const handleSubmit = async () => {
    ...
    setError(null);
    try {
      await storeService.uploadTransferProof(purchaseId, file, reference || undefined);
      navigate(`/tienda/confirmacion/${purchaseId}`);
    } catch (e) {
    ...
    <div className="checkout-page checkout-page--narrow">
      <div className="checkout-page__header">
        ...
        <p className="checkout-page__subtitle">
          Tu compra queda pendiente hasta que validemos el pago — te avisamos por mail.
        </p>
      </div>
